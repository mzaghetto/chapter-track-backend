...
describe('Get Unread Manhwas Use Case', () => {
  ...
  it('should be able to get all unread manhwas of user', async () => {
    ...
    expect(unreadManhwas).toEqual([
      expect.objectContaining({ manhwaId: 3n, lastEpisodeRead: 1, lastEpisodeReleased: 2 }),
      expect.objectContaining({ manhwaId: 12n, lastEpisodeRead: 1, lastEpisodeReleased: 2 }),
    ])
  })
